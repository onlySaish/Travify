...
function SignupStep3({ userData }) {
  ...
  return (
    <>
    <div className='h-fit w-3/4 bg-black/75 flex flex-col justify-center items-center rounded-3xl lg:w-2/5 py-4'>
        <form 
          ...
          <div className='text-white text-xl font-bold md:text-4xl lg:text-3xl lg:mt-2'>CREATE ACCOUNT</div>
                ...
                <div className='w-11/12 px-4 py-1 font-medium'>
                    <div className='text-white text-sm px-3 md:text-xl'>Enter Phone Number</div>
                    <input 
                    className='w-full mt-2 h-8 text-sm pl-3 py-4 rounded-3xl text-white border md:h-12 md:text-2xl lg:text-xl lg:h-10'
                ...
                <button className='cursor-pointer h-auto text-white w-2/4 text-lg font-bold bg-orange-500 mt-2 px-2 py-1 md:py-2 rounded-3xl md:text-3xl md:mt-4 lg:text-2xl lg:py-1 lg:w-1/3'>
                  Sign Up
                </button>
            </form>
        </div>
